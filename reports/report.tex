...
Extensive Exploratory Data Analysis was performed to understand the characteristics of the AG News dataset. Key findings include:
\begin{itemize}[leftmargin=*]
...
\end{itemize}
These findings motivated our use of standard TF-IDF and SBERT models without the need for complex outlier handling.
...
\bottomrule
\end{tabular}
\caption{TF-IDF model comparison from \texttt{reports/tables/tfidf\_model\_comparison.csv}.}
\end{table}
...
\bottomrule
\end{tabular}
\caption{Best embedding model per scale from \texttt{reports/tables/bert\_benchmark\_summary.csv}.}
\end{table}
...
The project exports reproducible artifacts under \texttt{features/} and \texttt{reports/}, including:
\begin{itemize}[leftmargin=*]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\linewidth]{figures/cm_svm.png}
